local Translations = {
    error = {
        ...
        duplicate_license           = '[RXCORE] - Знайдено дубльовану ліцензію Rockstar',
        no_valid_license            = '[RXCORE] - Не знайдено дійсної ліцензії Rockstar',
        not_whitelisted             = '[RXCORE] - Ви не у білому списку цього сервера',
        ...
        ban_table_not_found         = '[RXCORE] - Не вдалося знайти таблицю банів у базі даних. Переконайтеся, що SQL файл імпортовано правильно.',
        connecting_database_error   = '[RXCORE] - Сталася помилка при підключенні до бази даних. Переконайтеся, що SQL сервер працює і дані в файлі server.cfg вірні.',
        connecting_database_timeout = '[RXCORE] - Підключення до бази даних вичерпало час. Переконайтеся, що SQL сервер працює і дані в файлі server.cfg вірні.',
    },
    success = {
...
if GetConvar('rx_locale', 'en') == 'ua' then
