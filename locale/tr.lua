local Translations = {
    error = {
        ...
        duplicate_license           = '[RXCORE] - Aynı Rockstar Lisansı Bulundu',
        no_valid_license            = '[RXCORE] - Geçerli Rockstar Lisansı Bulunamadı',
        not_whitelisted             = '[RXCORE] - Bu sunucu için beyaz listedesiniz',
        ...
        ban_table_not_found         = '[RXCORE] - Veritabanında yasaklılar tablosu bulunamadı. Lütfen SQL dosyasının doğru şekilde yüklendiğinden emin olun.',
        connecting_database_error   = '[RXCORE] - Veritabanına bağlanırken hata oluştu. SQL sunucusunun çalıştığından ve server.cfg dosyasındaki bilgilerin doğru olduğundan emin olun.',
        connecting_database_timeout = '[RXCORE] - Veritabanı bağlantısı zaman aşımına uğradı. SQL sunucusunun çalıştığından ve server.cfg dosyasındaki bilgilerin doğru olduğundan emin olun.',
    },
    success = {
...
if GetConvar('rx_locale', 'en') == 'tr' then
    Lang = Locale:new({
