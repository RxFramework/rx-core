local Translations = {
    error = {
        ...
        duplicate_license           = '[RXCORE] - Rockstarライセンスが重複しています',
        no_valid_license            = '[RXCORE] - 有効なRockstarライセンスが見つかりません',
        not_whitelisted             = '[RXCORE] - あなたはホワイトリストに登録されていません',
        ...
        connecting_database_error   = '[RXCORE] - サーバーへの接続中にデータベースエラーが発生しました(SQLサーバの稼働を確認してください)',
        connecting_database_timeout = '[RXCORE] - データベースへの接続がタイムアウトしました(SQLサーバーの稼働を確認してください)',
    },
    success = {
...
if GetConvar('rx_locale', 'en') == 'ja' then
    Lang = Locale:new({
