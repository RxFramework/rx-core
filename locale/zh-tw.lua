local Translations = {
    error = {
        ...
        duplicate_license           = '[RXCORE] - 發現重複的 Rockstar 授權',
        no_valid_license            = '[RXCORE] - 找不到有效的 Rockstar 授權',
        not_whitelisted             = '[RXCORE] - 您不在此伺服器的白名單中',
        server_already_open         = '伺服器已經開啟',
        server_already_closed       = '伺服器已經關閉',
        no_permission               = '您沒有此權限..',
        no_waypoint                 = '尚未設置導航點',
        tp_error                    = '傳送時發生錯誤',
        ban_table_not_found         = '[RXCORE] - 無法在資料庫中找到封禁清單。請確認您已正確匯入 SQL 檔案。',
        connecting_database_error   = '[RXCORE] - 連接資料庫時發生錯誤。請確保 SQL 伺服器正在運行,且 server.cfg 檔案中的設定正確。',
        connecting_database_timeout = '[RXCORE] - 資料庫連接超時。請確保 SQL 伺服器正在運行,且 server.cfg 檔案中的設定正確。',
    },
    success = {
...
if GetConvar('rx_locale', 'en') == 'zh-tw' then
    Lang = Locale:new({
