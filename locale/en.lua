local Translations = {
    error = {
        ...
        duplicate_license           = '[RXCORE] - Duplicate Rockstar License Found',
        no_valid_license            = '[RXCORE] - No Valid Rockstar License Found',
        not_whitelisted             = '[RXCORE] - You\'re not whitelisted for this server',
        ...
        ban_table_not_found         = '[RXCORE] - Unable to find the bans table in the database. Please ensure you have imported the SQL file correctly.',
        connecting_database_error   = '[RXCORE] - An error occurred while connecting to the database. Ensure that the SQL server is running and that the details in the server.cfg file are correct.',
        connecting_database_timeout = '[RXCORE] - The database connection has timed out. Ensure that the SQL server is running and that the details in the server.cfg file are correct.',
    },
    success = {
