local Translations = {
    error = {
        ...
        duplicate_license           = '[RXCORE] - டூப்ளிகேட் ராக்ஸ்டார் உரிமம் கிடைத்தது',
        no_valid_license            = '[RXCORE] - சரியான ராக்ஸ்டார் உரிமம் இல்லை',
        not_whitelisted             = '[RXCORE] - இந்த சேவையகத்திற்கு நீங்கள் அனுமதிப்பட்டியலில் இல்லை',
        ...
        connecting_database_error   = '[RXCORE] - சேவையகத்துடன் இணைக்கும் போது தரவுத்தளப் பிழை ஏற்பட்டது. (SQL சர்வர் இயக்கத்தில் உள்ளதா?)',
        connecting_database_timeout = '[RXCORE] - தரவுத்தளத்திற்கான இணைப்பு நேரம் முடிந்தது. (SQL சர்வர் இயக்கத்தில் உள்ளதா?)',
    },
    success = {
...
if GetConvar('rx_locale', 'en') == 'ta' then
    Lang = Locale:new({
