local Translations = {
    error = {
        ...
        connecting_database_error   = '[RXCORE] - Un error en la base de datos sucedió mientras te conectabas al servidor (¿Está la SQL del servidor encendida?)',
        connecting_database_timeout = '[RXCORE] - La conexión con la base de datos falló (¿Está la SQL del servidor encendida?)',
    },
    success = {
