local Translations = {
    error = {
        ...
        duplicate_license           = '[RXCORE] - दोहोरिएको रकस्टार लाइसेन्स भेटियो',
        no_valid_license            = '[RXCORE] - मान्य रकस्टार लाइसेन्स भेटिएन',
        not_whitelisted             = '[RXCORE] - तपाईं यस सर्भरको लागि सेतो सूचीमा हुनुहुन्न',
        ...
        ban_table_not_found         = '[RXCORE] - डाटाबेसमा प्रतिबन्ध तालिका फेला पार्न सकेन। कृपया तपाईंले SQL फाइल सही रूपमा आयात गरेको सुनिश्चित गर्नुहोस्।',
        connecting_database_error   = '[RXCORE] - डाटाबेससँग जडान गर्दा त्रुटि भयो। कृपया SQL सर्भर चलिरहेको छ र server.cfg फाइलमा विवरणहरू सही छन् भन्ने सुनिश्चित गर्नुहोस्।',
        connecting_database_timeout = '[RXCORE] - डाटाबेस जडानले समय समाप्त गर्यो। कृपया SQL सर्भर चलिरहेको छ र server.cfg फाइलमा विवरणहरू सही छन् भन्ने सुनिश्चित गर्नुहोस्।',
    },
    success = {
...
if GetConvar('rx_locale', 'en') == 'np' then
    Lang = Locale:new({
