...
RXShared.Vehicles = RXShared.Vehicles or {}
...
RXShared.VehicleHashes = RXShared.VehicleHashes or {}
for i = 1, #Vehicles do
    local hash = joaat(Vehicles[i].model)
    RXShared.Vehicles[Vehicles[i].model] = {
    ...
    RXShared.VehicleHashes[hash] = RXShared.Vehicles[Vehicles[i].model]
end
